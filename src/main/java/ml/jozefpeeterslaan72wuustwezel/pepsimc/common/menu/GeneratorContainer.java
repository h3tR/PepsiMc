        ...
        addDataSlot(new DataSlot() {
            ...
            public void set(int value) {
                entity.getCapability(CapabilityEnergy.ENERGY).ifPresent(h -> {
                    ...
                    ((AutomatedProcessingBlockEntity.CustomEnergyStorage)h).setEnergy(energyStored + (value & 0xffff));
                });
            }
        });
        addDataSlot(new DataSlot() {
            ...
            public void set(int value) {
                entity.getCapability(CapabilityEnergy.ENERGY).ifPresent(h -> {
                    ...
                    ((AutomatedProcessingBlockEntity.CustomEnergyStorage)h).setEnergy(energyStored | (value << 16));
                });
            }
        });
    }
