...
public class RecyclerRecipeCategory implements IRecipeCategory<RecyclerRecipe>{
	...
	@Override
	public @NotNull Class<? extends RecyclerRecipe> getRecipeClass() {
	...
	@Override
	public void draw(@NotNull RecyclerRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull PoseStack stack, double mouseX, double mouseY) {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder LayoutBuilder, RecyclerRecipe recipe, @NotNull IFocusGroup focusGroup) {
