...
public class RecyclerRenderer extends GeoBlockRenderer<RecyclerTile> {
	...
	@Override
	public RenderType getRenderType(RecyclerTile animatable, float partialTicks, PoseStack stack,
