...
public record PepsiMcVegetalMod(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
    @Override
    ...
    public Codec<? extends BiomeModifier> codec() {
        return PepsiMcBiomeModifiers.VEGETAL_MODIFIER.get();
    }
}