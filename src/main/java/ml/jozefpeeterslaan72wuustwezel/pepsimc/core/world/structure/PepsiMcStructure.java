...
/*
    public static final DeferredRegister<StructureType<?>> STRUCTURES = DeferredRegister.create(Registry.STRUCTURE_TYPE_REGISTRY, "pepsimc");

    //**
     * Registers the base structure itself and sets what its path is. In this case,
     * this base structure will have the resourcelocation of structure_tutorial:sky_structures.
    // /
    public static final RegistryObject<StructureType<abandonedBottlingPlantStructure>> SKY_STRUCTURES = STRUCTURES.register("abandoned_bottling_plant", () -> () -> abandonedBottlingPlantStructure.CODEC);
    public static void register(IEventBus bus) {
