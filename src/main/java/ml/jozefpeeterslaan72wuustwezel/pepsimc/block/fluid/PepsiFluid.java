...
public abstract class PepsiFluid extends FlowingFluid {
   public Fluid getFlowing() {
      return fluid.PEPSI_FLOW.get();
   }

   public Fluid getSource() {
      return fluid.PEPSI_FLUID.get();
   }

   public Item getBucket() {
      return item.PEPSI_FLUID_BUCKET.get();
   }
   ...
   public boolean isSame(Fluid p_207187_1_) {
      return p_207187_1_ == fluid.PEPSI_FLUID.get() || p_207187_1_ == fluid.PEPSI_FLOW.get();
   }
