...
public class PepsiMcFluid {
	...
	public static final RegistryObject<Source> PEPSI_FLUID = FLUIDS.register("pepsifluid", ()-> new ForgeFlowingFluid.Source(PepsiMcFluid.PEPSI_PROPERTIES));
	
	public static final RegistryObject<FlowingFluid> PEPSI_FLOW = FLUIDS.register("pepsiflow", ()-> new ForgeFlowingFluid.Flowing(PepsiMcFluid.PEPSI_PROPERTIES));
	
	public static final RegistryObject<Source> PEPSI_MAX_FLUID = FLUIDS.register("pepsimaxfluid", ()-> new ForgeFlowingFluid.Source(PepsiMcFluid.PEPSI_MAX_PROPERTIES));
	
	public static final RegistryObject<FlowingFluid> PEPSI_MAX_FLOW = FLUIDS.register("pepsimaxflow", ()-> new ForgeFlowingFluid.Flowing(PepsiMcFluid.PEPSI_MAX_PROPERTIES));
	...
	public static final ForgeFlowingFluid.Properties PEPSI_PROPERTIES = new ForgeFlowingFluid.Properties(
			...
			).levelDecreasePerBlock(2).slopeFindDistance(6).bucket(()->PepsiMcItem.PEPSI_FLUID_BUCKET.get()).block(()->PepsiMcBlock.PEPSI_FLUID_BLOCK.get());
	...
	public static final ForgeFlowingFluid.Properties PEPSI_MAX_PROPERTIES = new ForgeFlowingFluid.Properties(
			...
			).levelDecreasePerBlock(2).slopeFindDistance(6).bucket(()->PepsiMcItem.PEPSI_MAX_FLUID_BUCKET.get()).block(()->PepsiMcBlock.PEPSI_MAX_FLUID_BLOCK.get());
}
