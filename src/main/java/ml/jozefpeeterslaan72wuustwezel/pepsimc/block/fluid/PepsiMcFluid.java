...
public class PepsiMcFluid {
	...
	public static final RegistryObject<FlowingFluid> PEPSI_FLOW = FLUIDS.register("pepsi_flow", ()-> new ForgeFlowingFluid.Flowing(PepsiMcFluid.PEPSI_PROPERTIES));
	
	public static final RegistryObject<Source> PEPSI_MAX_FLUID = FLUIDS.register("pepsi_max_fluid", ()-> new ForgeFlowingFluid.Source(PepsiMcFluid.PEPSI_MAX_PROPERTIES));
	
	public static final RegistryObject<FlowingFluid> PEPSI_MAX_FLOW = FLUIDS.register("pepsi_max_flow", ()-> new ForgeFlowingFluid.Flowing(PepsiMcFluid.PEPSI_MAX_PROPERTIES));
