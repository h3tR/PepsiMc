...
import ml.jozefpeeterslaan72wuustwezel.pepsimc.item.*;

public abstract class PepsiMaxFluid extends FlowingFluid {
   public Fluid getFlowing() {
      return fluid.PEPSI_MAX_FLOW.get();
   }

   public Fluid getSource() {
      return fluid.PEPSI_MAX_FLUID.get();
   }

   public Item getBucket() {
      return item.PEPSI_MAX_FLUID_BUCKET.get();
   }
   ...
   public boolean isSame(Fluid p_207187_1_) {
      return p_207187_1_ == fluid.PEPSI_MAX_FLUID.get() || p_207187_1_ == fluid.PEPSI_MAX_FLOW.get();
   }
   ...
   public static class Flowing extends PepsiMaxFluid {
   ...
   public static class Source extends PepsiMaxFluid {
      public int getAmount(FluidState p_207192_1_) {
         return 8;
      }
