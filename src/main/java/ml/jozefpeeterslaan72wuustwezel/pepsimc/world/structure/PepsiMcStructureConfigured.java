...
public class PepsiMcStructureConfigured {
	public static StructureFeature<?, ?> CONFIGURED_ABANDONED_BOTTLING_PLANT = PepsiMcStructure.ABANDONED_BOTTLING_PLANT.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation("pepsimc", "configured_abandoned_bottling_plant"), CONFIGURED_ABANDONED_BOTTLING_PLANT);
        ...
        */
       // FlatGenerationSettings.STRUCTURE_FEATURES.put(PepsiMcStructure.ABANDONED_BOTTLING_PLANT.get(), CONFIGURED_ABANDONED_BOTTLING_PLANT);
    }
}
